	...
	<div class="container-fluid">
		...
		<div class="row">
			...
			<div class="col-md-4  green lighten-5">
				<div id="scrollspy" class="sticky fixedElement blue lighten-5">
					<ul class="nav nav-nav-tabs md-pills pills-primary smooth-scroll flex-column" role="tablist">
						<li class="nav-item"><a class="nav-link" href="#id1" data-toggle="tab" role="tab">title 1</a></li>
